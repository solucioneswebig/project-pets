...
<section>
	...
	<div class="container">
		<div class="row">
            ...
            <a href="<?php echo get_site_url(); ?>/mi-cuenta/?slug=mis_finanzas" class="list-group-item list-group-item-action <?php if(isset($_GET["slug"]) && $_GET["slug"] == "mis_finanzas" || $_GET["slug"] == "cargar_saldo"){ echo "active"; } ?>">Mis finanzas</a>
