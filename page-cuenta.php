...
<section>
	...
	<div class="container">
		<div class="row">
            ...
            <a href="<?php echo get_site_url(); ?>/mi-cuenta/?slug=lista_servicios" class="list-group-item list-group-item-action <?php if(isset($_GET["slug"]) && $_GET["slug"] == "list" || $_GET["slug"] == "add_new" || $_GET["slug"] == "edit_post"){ echo "active"; } ?>">Lista servicios</a>
